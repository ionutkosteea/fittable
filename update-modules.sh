...
rm ./angular-app/ngx-fittable-docs/src/assets/code-snippets/fittable-component-diagram.jpg
cp fittable-component-diagram.jpg ./angular-app/ngx-fittable-docs/src/assets/code-snippets
...
rm ./angular-lib/projects/fittable-angular/LICENSE
cp LICENSE ./angular-lib/projects/fittable-angular
rm ./angular-lib/projects/fittable-angular/README.md
cp README.md ./angular-lib/projects/fittable-angular
rm ./angular-lib/projects/fittable-angular/architecture.jpg
cp architecture.jpg ./angular-lib/projects/fittable-angular

rm ./angular-app/ngx-fittable-docs/src/assets/code-snippets/architecture.jpg
cp architecture.jpg ./angular-app/ngx-fittable-docs/src/assets/code-snippets
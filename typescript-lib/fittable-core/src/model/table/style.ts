...
export type CssStyle = { [name in string]?: CssValue };

export interface Style {
  getDto(): unknown;
  set(name: string, value?: CssValue): this;
  get(name: string): CssValue | undefined;
  remove(name: string): this;
  forEach(propertyFn: (name: string, value?: CssValue) => boolean): void;
  toCss(): CssStyle;
  toCssText(): string;

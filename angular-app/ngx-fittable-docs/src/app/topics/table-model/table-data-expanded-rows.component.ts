...
@Component({
  selector: 'table-data-expanded-rows',
  templateUrl: './common/console-topic.html',
  styleUrls: ['../common/common.css'],
})
export class TableDataExpandedRowsComponent extends ConsoleTopic implements OnInit {
  @ViewChild('console') console!: ElementRef;

  public override readonly isConsoleDisabled = true;
  readonly title: TopicTitle = 'Table data-expanded rows';
  readonly htmlCode: CodeSnippet[] = [
    { image: 'fittable-component-html.jpg' },
  ];
  readonly typescriptCode: CodeSnippet[] = [
    { image: 'table-data-expanded-rows-ts-01.jpg' },
    { image: 'table-data-expanded-rows-ts-02.jpg' },
